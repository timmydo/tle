...
(defun test-beginning-of-line-basic ()
  "Test basic beginning-of-line functionality"
  (format t "Running beginning-of-line basic tests...~%")
  
  ;; Test 1: Move to beginning from middle of line
  (let ((buf (make-instance 'standard-buffer)))
    ...
    (format t "✓ Test 1 passed: Move to beginning from middle of line~%"))
  
  ;; Test 2: Move to beginning from end of line
  (let ((buf (make-instance 'standard-buffer)))
    (setf (lines buf) #("hello world"))
    ...
    (format t "✓ Test 2 passed: Move to beginning from end of line~%"))
  
  ;; Test 3: Already at beginning of line
  (let ((buf (make-instance 'standard-buffer)))
    (setf (lines buf) #("hello world"))
    ...
    (format t "✓ Test 3 passed: Already at beginning of line~%"))
  
  (format t "All beginning-of-line basic tests passed!~%~%"))

(defun test-beginning-of-line-multi-line ()
  "Test beginning-of-line on different lines"
  (format t "Running beginning-of-line multi-line tests...~%")
  ...
  (let ((buf (make-instance 'standard-buffer)))
    ...
    (format t "✓ Test 1 passed: Beginning of second line~%"))
  ...
  (let ((buf (make-instance 'standard-buffer)))
    ...
    (beginning-of-line buf)
    (let ((point (buffer-get-point buf)))
      (assert (equal point '(2 0)) () "Test 2 failed: expected (2 0), got ~A" point))
    (format t "✓ Test 2 passed: Beginning of last line~%"))
  ...
  (let ((buf (make-instance 'standard-buffer)))
    ...
    (let ((point (buffer-get-point buf)))
      (assert (equal point '(0 0)) () "Test 3 failed: expected (0 0), got ~A" point))
    (format t "✓ Test 3 passed: Beginning of first line~%"))
  
  (format t "All beginning-of-line multi-line tests passed!~%~%"))

(defun test-beginning-of-line-edge-cases ()
  "Test beginning-of-line edge cases"
  (format t "Running beginning-of-line edge case tests...~%")
  ...
  (let ((buf (make-instance 'standard-buffer)))
    ...
    (beginning-of-line buf)
    (let ((point (buffer-get-point buf)))
      (assert (equal point '(2 0)) () "Test 2b failed: expected (2 0), got ~A" point))
  ...
  (format t "All beginning-of-line edge case tests passed!~%~%"))

(defun test-beginning-of-line-with-undo ()
  "Test beginning-of-line with undo functionality (movement operations typically don't record undo)"
  (format t "Running beginning-of-line undo tests...~%")
  ...
  (format t "All beginning-of-line undo tests passed!~%~%"))

(defun test-beginning-of-line-integration ()
  "Test beginning-of-line integration with other functions"
  (format t "Running beginning-of-line integration tests...~%")
  
  ;; Test 1: beginning-of-line after character movements
  (let ((buf (make-instance 'standard-buffer)))
    (setf (lines buf) #("hello world"))
    (buffer-set-point buf 0 0)
    (forward-char buf)
    ...
    (let ((after-bol (buffer-get-point buf)))
      (assert (equal after-bol '(0 0)) () "beginning-of-line after chars failed: expected (0 0), got ~A" after-bol))
    (format t "✓ Test 1 passed: beginning-of-line after character movements~%"))
  
  ;; Test 2: beginning-of-line after line movements
  (let ((buf (make-instance 'standard-buffer)))
    (setf (lines buf) #("first line" "second line" "third line"))
    (buffer-set-point buf 0 5)
    (next-line buf)
    ...
    (beginning-of-line buf)
    (let ((after-bol (buffer-get-point buf)))
      (assert (equal after-bol '(1 0)) () "beginning-of-line after line move failed: expected (1 0), got ~A" after-bol))
    (format t "✓ Test 2 passed: beginning-of-line after line movements~%"))
  
  ;; Test 3: Character movement after beginning-of-line
  (let ((buf (make-instance 'standard-buffer)))
    (setf (lines buf) #("hello world"))
    (buffer-set-point buf 0 8)
    (beginning-of-line buf)
    ...
    (let ((final-point (buffer-get-point buf)))
      (assert (equal final-point '(0 2)) () "Movement after beginning-of-line failed: expected (0 2), got ~A" final-point))
    (format t "✓ Test 3 passed: Character movement after beginning-of-line~%"))
  
  (format t "All beginning-of-line integration tests passed!~%~%"))

(defun run-all-beginning-of-line-tests ()
  "Run all beginning-of-line tests"
  (format t "~%======================================~%")
  (format t "Running Beginning-of-Line Tests~%")
  (format t "======================================~%~%")
  
  (handler-case
      (progn
        (test-beginning-of-line-basic)
        (test-beginning-of-line-multi-line)
        (test-beginning-of-line-edge-cases)
        (test-beginning-of-line-with-undo)
        (test-beginning-of-line-integration)
        (format t "~%======================================~%")
        (format t "All beginning-of-line tests passed successfully!~%")
        (format t "======================================~%"))
    (error (e)
